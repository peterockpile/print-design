...
from pdesign import uc2const
from pdesign.uc2const import COLOR_RGB, COLOR_CMYK, COLOR_LAB, COLOR_GRAY, \
COLOR_SPOT
...
class ColorManager:
	"""
	The class provides simple color manager.
	Emulates full-featured UC2 Color Manager.
	"""
