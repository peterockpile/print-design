...
CTX_CIRCLE_END_OFF = 'ctx-circle-end_off'
CTX_CIRCLE_END_ON = 'ctx-circle-end_on'
CTX_CIRCLE_START_OFF = 'ctx-circle-start_off'
CTX_CIRCLE_START_ON = 'ctx-circle-start_on'
...
CTX_ICONS = [CTX_PAGE_LANDSCAPE, CTX_PAGE_PORTRAIT, CTX_UNITS, CTX_OBJECT_JUMP,
			...
			CTX_CIRCLE_CHORD, CTX_CIRCLE_PIE_SLICE, CTX_CIRCLE_END_OFF,
			CTX_CIRCLE_END_ON, CTX_CIRCLE_START_OFF, CTX_CIRCLE_START_ON]
